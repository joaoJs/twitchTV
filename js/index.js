$(document).ready(function() {
  ...
  // json array with info similar to the one obtained from twitch's api
  var json = [
  {
    "stream": {
      "mature": false,
  ...
  //when all is clicked, show all channels
  $("#all").on("click", function() {
    $(".sonline").show();
    $(".soffline").show();
  });
  
  // when online is clicked show only online channels
  ...
  // when offline is clicked, show only offline channes
